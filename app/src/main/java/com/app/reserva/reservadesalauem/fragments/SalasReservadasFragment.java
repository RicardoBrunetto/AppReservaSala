...
public class SalasReservadasFragment extends Fragment implements View.OnClickListener{
    ...
    public SalasReservadasFragment() {
     ...
     * @return A new instance of fragment SalasReservadasFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SalasReservadasFragment newInstance(String param1, String param2) {
        SalasReservadasFragment fragment = new SalasReservadasFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_salas_reservadas, container, false);
        spnSalasReservadasDepartamento = (Spinner) view.findViewById(R.id.spnSalasReservadasDepartamento);

        spnSalasReservadasDepartamento.requestFocus();

        edtSalasReservadasData = (EditText) view.findViewById(R.id.edtSalasReservadasData);


        btnSalasReservadasAnterior = (Button) view.findViewById(R.id.btnSalasReservadasAnterior);
        btnSalasReservadasAnterior.setOnClickListener(this);

        txtSalasReservadasSala = (TextView) view.findViewById(R.id.txtSalasReservadasSala);

        btnSalasReservadasProximo = (Button) view.findViewById(R.id.btnSalasReservadasProximo);
        btnSalasReservadasProximo.setOnClickListener(this);

        lstSalasReservadasReservas = (ListView) view.findViewById(R.id.lstSalasReservadasReservas);

        btnSalasReservadasVoltar = (Button) view.findViewById(R.id.btnSalasReservadasVoltar);
    ...
    public void preencherSpinner(){
        ...
        adpDepartamento = new ArrayAdapter<Departamento>(getContext(),android.R.layout.simple_list_item_1);
        ...
        adpSala = new ArrayAdapter<Sala>(getContext(),android.R.layout.simple_list_item_1);
    ...
    public void listar(){
        ...
        adpReserva = new ListarReservaPorArrayAdapter(getContext(),R.layout.item_listar_reserva_por);
